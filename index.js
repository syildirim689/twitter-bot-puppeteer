...
async function tweetLike() {
    try {
        ...
        console.log("Twitter'a giriş yapıldı.")
        await page.waitForResponse('https://twitter.com/gitresmi')
        await page.goto('https://twitter.com/gitresmi', { waitUntil: 'networkidle2' })
        console.log("Tweetler yükleniyor...")
        await page.waitForSelector('div[class="css-1dbjc4n r-18u37iz r-1h0z5md"]')
        await page.click('div[class="css-1dbjc4n r-18u37iz r-1h0z5md"]',
            { clickCount: 1, delay: 50, }
        )
    } catch (error) {
        console.log(error)
